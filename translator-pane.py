...
def watch_requests(config: dict, glossary: dict, dry_run: bool) -> None:
    ...
    print("Select text in Claude Code, then press Ctrl+Alt+T; double Ctrl is fallback.")
    print("In Claude Code menus/TUI pickers, hold Shift while selecting text. Press Ctrl+C to exit this pane.")
